                                        ...
                                        <tbody>
                                            <tr class="tr-shadow">
                                                ...
                                                <td>
                                                    ...
                                                    <div class="table-data-feature">
                                                       <td> 
                                                        <button type="submit" class="btn btn-primary btn-sm">
                                                         <i class="fa fa-dot-circle-o"><a href="index.php?c=usuarios&a=update&id=<?= $usuario->id_usuario; ?>"style="color:#f6f7f9;">Editar</a></i> 
                                                </button>
                                                        </td>
                                                        <td>
                                                    ...
                                                    <i class="fa fa-ban"><a href="index.php?c=usuarios&a=delete&id=<?= $usuario->id_usuario; ?>" style="color:#f6f7f9;" >Eliminar</a></i> 
                                                </button>
                                                        </td>
                                                    </div>
                                            </tr>
